...
export default function UserDashboardView() {
  ...
  const stats = {
    ...
    belumDitangani: disasters.filter(d => d.statusTangani === 'BELUM_DITANGANI').length
  };
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-sm">
            ...
            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-1 sm:mb-2">{stats.belumDitangani}</div>
            <div className="text-gray-500 font-medium text-xs sm:text-sm lg:text-base">Belum Ditangani</div>
          </div>
        </div>
